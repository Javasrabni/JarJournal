...
const KalenderPage = () => {
    ...
    return (
        <>
            <Header />
            <div className='mb-[12px] absolute top-[18px] right-[16px]'>
                <div>
                    ...
                    <button onClick={() => setIsModalOpen(true)} className={`${themeActive ? 'bg-white text-black' : 'bg-black text-white'} px-[16px] py-[6px] rounded-[8px]`}>
                        <p className='text-[11px]'>Tambah acara</p>
                    </button>
                </div>
                <div>
            ...
            <div className="w-full h-full flex justify-center " style={{ paddingBottom: '32px', backgroundColor: '#141414' }}>
                <div className="w-[360px] h-full p-[16px]">
                    ...
                    <ConfigProvider theme={{
                        ...
                        token: {
                            colorPrimary: '#1890ff', // Warna utama
                            colorBgBase: '#000000', // Background dasar
                            colorTextBase: '#fff', // Teks dasar
                            colorBorder: 'rgb(38, 38, 38)' // Warna border
                        },
                    }}>
                        <List
                            bordered
