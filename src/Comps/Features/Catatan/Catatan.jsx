...
export default function Catatan() {
    ...
    return (
        <>
            <div className={`max-w-[42rem] w-full h-full ${themeActive ? 'bg-[var(--bg-12)]' : 'bg-white'} flex jusitfy-center relative`}>
                {/* Main content */}
                        ...
                        {!writeingNote && (
                            <>
                                <div className="max-w-[22rem] fixed bottom-[12px] left-[50%] translate-x-[-50%] w-full p-[16px] z-[20]">
                                    <div className=" h-[42px] w-full cursor-pointer bg-[var(--blue-clr)] rounded-[12px] flex items-center justify-center">
