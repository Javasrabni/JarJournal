        ...
        <>
            <div className="w-full h-full flex justify-center items-center" >
                {userClickQuote ? (
                    ...
                    <p className={`text-[10px] font-[500] text-center ${themeActive ? 'text-white' : 'text-[var(--black-text)]'}`} style={{ filter: themeActive ?  "drop-shadow(gold 0px 0px 0px)" : 'drop-shadow(gold 0px 0px 0px)' }}>
