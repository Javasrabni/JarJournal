...
export default function PlusBtn({temaCatatan}) {
    ...
    return (
        <div className={`w-[40px] h-[40px] fixed ${temaCatatan && themeActive ? 'bg-white' : 'bg-[var(--black-card)]' } bottom-[32px] right-[50%] rounded-[50px] flex items-center justify-center cursor-pointer`} style={{transform: 'translateX(50%)'}}>
